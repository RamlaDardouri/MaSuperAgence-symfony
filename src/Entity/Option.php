...
class Option
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Proprety::class, mappedBy="options")
     */
    private $propreties;
    ...
    public function addProprety(Proprety $proprety): self
    {
    ...
    public function removeProprety(Proprety $proprety): self
    {
